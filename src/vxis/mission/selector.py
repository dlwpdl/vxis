...
SCOPE_AGENTS: dict[str, list[str]] = {
    ...
    "cloud": [
        "recon", "cloud", "container_k8s", "supply_chain",
        "secrets_lifecycle", "iam_deep", "compliance",
    ],
    "code": [
        "supply_chain", "secrets_lifecycle", "deserialization",
        "sast", "sbom", "compliance",
    ],
    "network": [
        "recon", "network", "l2_network", "ipv6",
...
DEPTH_DISABLED: dict[str, list[str]] = {
    "passive": [
        "dos_resilience", "fuzzing_zerodday", "side_channel",
        "dma_attack", "ss7_cellular", "cold_boot_memory",
        "deserialization", "data_exfiltration",
    ],
    "normal": [
        "fuzzing_zerodday", "side_channel", "dma_attack",
