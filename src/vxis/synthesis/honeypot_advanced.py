...
STRIPE_SECRET_KEY=sk_live_51H7bLfKs8WpJ2mRwY7FvZYx  # gitleaks:allow -- decoy
SLACK_BOT_TOKEN=xoxb-123456789012-1234567890123-aB1cD2eF3gH4iJ5kL6mN7oP  # gitleaks:allow -- decoy
...
class HoneypotLearner:
    ...
    def generate_nuclei_templates(self, analysis: dict) -> list[str]:
        ...
        for path, count in top_paths[:10]:
            ...
            template = f"""id: honeypot-learned-{hashlib.md5(path.encode(), usedforsecurity=False).hexdigest()[:8]}
info:
