...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Map finding types to valid vector IDs from the registry.
        # IDs must match vxis.scoring.vectors exactly — unknown IDs are
        # silently dropped by ScoringEngine._calc_vector_coverage.
        _type_to_vector: dict[str, str] = {
            # ── Injection ──────────────────────────────────────────────────
            "sql_injection":        "WEB-SQLI-001",
            "sqli_blind_boolean":   "WEB-SQLI-002",
            "sqli_blind_time":      "WEB-SQLI-003",
            "sqli_error_based":     "WEB-SQLI-004",
            "sqli_oob":             "WEB-SQLI-005",
            "sqli_second_order":    "WEB-SQLI-006",
            ...
            "unrestricted_upload":  "WEB-UPLOAD-001",
