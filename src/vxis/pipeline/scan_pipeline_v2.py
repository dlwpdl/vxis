...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Map finding types to registry vector IDs (vxis.scoring.vectors).
        # All IDs must match the registry exactly or the scoring engine ignores them.
