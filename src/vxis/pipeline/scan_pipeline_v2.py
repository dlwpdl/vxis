...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Map finding_type strings → canonical vector IDs from registry
        # Covers all 82 WEB_VECTORS; multiple aliases per vector for Brain flexibility
        _type_to_vector: dict[str, str] = {
            # ── SQL Injection ──
            "sql_injection": "WEB-SQLI-001",
            "sql_injection_union": "WEB-SQLI-001",
            "union_based_sqli": "WEB-SQLI-001",
            ...
            "nosql_operator_injection": "WEB-NOSQL-001",
            ...
            "oob_command_injection": "WEB-CMDI-002",
            # ── LDAP / XPath / SSTI ──
            ...
            "file_path_traversal": "WEB-AC-004",
            ...
            "verbose_error_messages": "WEB-MISCONF-003",
            ...
            "websocket_message_injection": "WEB-WSS-001",
            # ── API-Specific ──
            ...
            "grpc_service_exposed": "WEB-API-006",
            "grpc_injection": "WEB-API-007",
            "grpc_method_enumeration": "WEB-API-007",
            "bopla": "WEB-API-008",
            ...
            "json_prototype_pollution": "WEB-INJECT-022",
            "csp_bypass": "WEB-INJECT-023",
            "csp_nonce_leak": "WEB-INJECT-023",
            "cache_poisoning": "WEB-INJECT-024",
            "web_cache_deception": "WEB-INJECT-024",
            "cache_deception": "WEB-INJECT-024",
            # ── Infrastructure ──
            "subdomain_takeover": "WEB-INFRA-001",
            "dangling_dns": "WEB-INFRA-001",
            ...
            "firebase_public_db": "WEB-INFRA-004",
            "exposed_git_repository": "WEB-INFRA-005",
            "git_exposure": "WEB-INFRA-005",
            "dot_git_exposed": "WEB-INFRA-005",
            "f5_bigip_rce": "WEB-INFRA-006",
            "cve_2025_53521": "WEB-INFRA-006",
            # ── CVE / Modern Threats ──
