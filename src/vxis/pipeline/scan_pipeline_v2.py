...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Map finding types to vector IDs — must reference IDs that exist in
        # vectors.py (WEB_VECTORS). Unknown IDs are silently dropped by the
        # scoring engine's valid_ids filter and contribute zero to coverage.
        _type_to_vector: dict[str, str] = {
            ...
            "privilege_escalation_via_state": "WEB-BIZ-005",
