...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Keys must match finding_type values emitted by the Brain/ScanAgentLoop.
        # All values are verified against WEB_VECTORS in vxis.scoring.vectors.
        _type_to_vector: dict[str, str] = {
            ...
            "sql_injection_second": "WEB-SQLI-006",
            # ── NoSQL ──
