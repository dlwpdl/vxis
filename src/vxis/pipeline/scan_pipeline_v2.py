...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Map finding_type → registered vector ID (vectors.py ground truth).
        # Keys are snake_case finding_type values the Brain emits.
        # Values MUST exist in WEB_VECTORS — unknown IDs score 0 (engine ignores them).
        _type_to_vector: dict[str, str] = {
            ...
            "open_redirect": "WEB-MISCONF-006",   # OAuth open-redirect → misconfig
            ...
            "business_logic_negative_value": "WEB-BIZ-001",
            "business_logic_state_bypass": "WEB-BIZ-002",
            "payment_race_condition": "WEB-BIZ-003",
            "transaction_replay": "WEB-BIZ-004",
            "business_logic_privilege": "WEB-BIZ-005",
            # ── API Security ──
