...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Detect target_type from findings; default to "web".
        _detected_type = "web"
        for _f in ctx.findings:
            _ftype = str(getattr(_f, "finding_type", "") or "").lower()
            _fid = str(getattr(_f, "id", "") or "").upper()
            if _fid.startswith("GAME-") or _ftype.startswith("game_"):
                _detected_type = "game"
                break
            if _fid.startswith("MOB-") or _ftype.startswith("mob_") or _ftype.startswith("mobile_"):
                _detected_type = "mobile"
                break
        tracker = ScoreTracker(target_type=_detected_type)

        # Map finding types → registered vector IDs (vectors.py is ground truth).
        # Covers all 82 WEB_VECTORS plus common Brain-reported aliases.
        # Game / mobile mappings are added below the web section.
        _type_to_vector: dict[str, str] = {
            ...
            "nosql_javascript_injection": "WEB-NOSQL-002",
            # ── OS Command Injection ──
            "command_injection": "WEB-CMDI-001",
            "cmd_injection": "WEB-CMDI-001",
            ...
            "redirect": "WEB-MISCONF-006",
            # ── Cryptographic Failures ──
            "weak_tls": "WEB-CRYPTO-001",
            "tls_misconfiguration": "WEB-CRYPTO-001",
            "weak_crypto": "WEB-CRYPTO-001",
            "weak_hashing": "WEB-CRYPTO-002",
            "md5_sha1_passwords": "WEB-CRYPTO-002",
            "hardcoded_secrets": "WEB-CRYPTO-003",
            "exposed_secrets": "WEB-CRYPTO-003",
            "hardcoded_api_key": "WEB-CRYPTO-003",
            "insecure_randomness": "WEB-CRYPTO-004",
            "predictable_tokens": "WEB-CRYPTO-004",
            # ── Injection: XXE / Deserialization / Upload ──
            "xxe": "WEB-XXE-001",
            ...
            "webshell_upload": "WEB-UPLOAD-001",
            # ── Race Condition / CSRF ──
            ...
            "bopla": "WEB-API-008",
            "broken_object_property_level_auth": "WEB-API-008",
            "bfla": "WEB-API-009",
            "broken_function_level_auth": "WEB-API-009",
            # ── Modern Injection ──
            "prototype_pollution": "WEB-INJECT-022",
            "csp_bypass": "WEB-INJECT-023",
            "nonce_leak": "WEB-INJECT-023",
            ...
            "state_machine_bypass": "WEB-BIZ-002",
            ...
            "integer_overflow_currency": "GAME-SV-002",
            "zero_price_purchase": "GAME-SV-003",
            "speed_hack": "GAME-SV-004",
            "teleport_bypass": "GAME-SV-005",
            "game_idor": "GAME-SV-006",
            "server_input_truncation": "GAME-SV-007",
            "name_truncation": "GAME-SV-007",
            "item_duplication": "GAME-ECON-001",
            "currency_manipulation": "GAME-ECON-002",
            "trade_rollback": "GAME-ECON-003",
            "gift_abuse": "GAME-ECON-004",
            "marketplace_price_manipulation": "GAME-ECON-005",
            "iap_bypass": "GAME-ECON-006",
            "receipt_forgery": "GAME-ECON-006",
            "binary_protocol_weak_integrity": "GAME-PROTO-001",
            "replay_attack": "GAME-PROTO-002",
            "packet_replay": "GAME-PROTO-002",
            "packet_injection": "GAME-PROTO-003",
            "state_desync": "GAME-PROTO-004",
            "client_server_desync": "GAME-PROTO-004",
            "memory_manipulation": "GAME-CLIENT-001",
            "binary_reverse_engineering": "GAME-CLIENT-002",
            "save_file_tampering": "GAME-CLIENT-003",
            "config_file_tampering": "GAME-CLIENT-004",
            "asset_manipulation": "GAME-CLIENT-005",
            "anti_cheat_assessment": "GAME-AC-001",
            "anti_cheat_bypass": "GAME-AC-002",
            "kernel_anti_cheat": "GAME-AC-003",
            "leaderboard_manipulation": "GAME-LOGIC-001",
            "matchmaking_abuse": "GAME-LOGIC-002",
            "elo_manipulation": "GAME-LOGIC-002",
            "cooldown_bypass": "GAME-LOGIC-003",
            "time_manipulation": "GAME-LOGIC-003",
            "gacha_manipulation": "GAME-LOGIC-004",
            "rng_manipulation": "GAME-LOGIC-004",
            "gm_command_injection": "GAME-LOGIC-005",
            "referral_code_abuse": "GAME-LOGIC-006",
            "chat_injection": "GAME-SOCIAL-001",
            "username_xss": "GAME-SOCIAL-002",
            "in_game_phishing": "GAME-SOCIAL-003",
            "guild_permission_escalation": "GAME-SOCIAL-004",
            "clan_abuse": "GAME-SOCIAL-004",
            "license_bypass": "GAME-DRM-001",
            "cloud_save_manipulation": "GAME-DRM-002",
            # ── Mobile vectors ──
            "hardcoded_api_keys": "MOB-STATIC-001",
            "apk_secrets": "MOB-STATIC-001",
            "weak_mobile_crypto": "MOB-STATIC-002",
            "mobile_des_ecb": "MOB-STATIC-002",
            "over_privileged_permissions": "MOB-STATIC-003",
            "exported_activity": "MOB-STATIC-004",
            "exported_service": "MOB-STATIC-004",
            "debug_flag_enabled": "MOB-STATIC-005",
            "android_debuggable": "MOB-STATIC-005",
            "backup_enabled": "MOB-STATIC-006",
            "android_allow_backup": "MOB-STATIC-006",
            "firebase_config_embedded": "MOB-STATIC-007",
            "google_services_config": "MOB-STATIC-007",
            "no_pie": "MOB-BINARY-001",
            "no_stack_canary": "MOB-BINARY-002",
            "no_code_obfuscation": "MOB-BINARY-003",
            "code_obfuscation_missing": "MOB-BINARY-003",
            "native_library_secrets": "MOB-BINARY-004",
            "so_secrets": "MOB-BINARY-004",
            "ssl_pinning_missing": "MOB-NET-001",
            "ssl_pinning_bypass": "MOB-NET-002",
            "cleartext_traffic": "MOB-NET-003",
            "http_cleartext": "MOB-NET-003",
            "certificate_validation_bypass": "MOB-NET-004",
            "trust_all_certs": "MOB-NET-004",
            "mobile_api_auth_flaw": "MOB-API-001",
            "mobile_idor": "MOB-API-002",
            "mobile_rate_limit_bypass": "MOB-API-003",
            "mobile_graphql_attack": "MOB-API-004",
            "mobile_grpc_reflection": "MOB-API-005",
            "sqlite_unencrypted": "MOB-STORE-001",
            "shared_preferences_exposure": "MOB-STORE-002",
            "keychain_misconfiguration": "MOB-STORE-003",
            "http_cache_leakage": "MOB-STORE-004",
            "webview_cache_leakage": "MOB-STORE-004",
            "clipboard_exposure": "MOB-STORE-005",
            "flag_secure_missing": "MOB-STORE-006",
            "screenshot_not_blocked": "MOB-STORE-006",
            "root_detection_bypass": "MOB-DYN-001",
            "jailbreak_detection_bypass": "MOB-DYN-001",
            "emulator_detection_bypass": "MOB-DYN-002",
            "anti_tamper_bypass": "MOB-DYN-003",
            "signature_check_bypass": "MOB-DYN-003",
            "frida_bypass": "MOB-DYN-004",
            "debugger_detection_bypass": "MOB-DYN-004",
            "dynamic_code_loading": "MOB-DYN-005",
            "dex_injection": "MOB-DYN-005",
            "iap_receipt_bypass": "MOB-BIZ-001",
            "iap_validation_flaw": "MOB-BIZ-001",
            "subscription_spoofing": "MOB-BIZ-002",
            "premium_feature_unlock": "MOB-BIZ-002",
            "deep_link_hijacking": "MOB-BIZ-003",
            "intent_scheme_hijack": "MOB-BIZ-003",
            "feature_flag_manipulation": "MOB-BIZ-004",
            "offline_mode_abuse": "MOB-BIZ-005",
            "intent_injection": "MOB-PLAT-001",
            "implicit_intent_hijack": "MOB-PLAT-001",
            "content_provider_exposure": "MOB-PLAT-002",
            "broadcast_abuse": "MOB-PLAT-003",
            "task_hijacking": "MOB-PLAT-004",
            "strandhog": "MOB-PLAT-004",
            "webview_js_bridge_abuse": "MOB-PLAT-005",
            "universal_links_hijack": "MOB-PLAT-006",
            "firebase_unauthenticated": "MOB-CLOUD-001",
            "firebase_db_unauthenticated": "MOB-CLOUD-001",
            "s3_public": "MOB-CLOUD-002",
            "cloud_function_exposed": "MOB-CLOUD-003",
            "third_party_sdk_cve": "MOB-SDK-001",
            "sdk_cve": "MOB-SDK-001",
            "analytics_sdk_leakage": "MOB-SDK-002",
            "push_notification_spoofing": "MOB-SDK-003",
            "improper_credential_usage": "MOB-PRIV-001",
            "inadequate_privacy_controls": "MOB-PRIV-002",
        ...
        engine = ScoringEngine(_detected_type)
