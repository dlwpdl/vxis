...
def _compute_vxis_score(ctx: Any) -> tuple[float, str]:
    ...
    try:
        ...
        # Map finding types to vector IDs registered in vxis.scoring.vectors.
        # All IDs must match WEB_VECTORS / GAME_VECTORS / MOBILE_VECTORS exactly;
        ...
        _type_to_vector = {
            ...
            "logic_privilege_escalation": "WEB-BIZ-005",
            # ── Infrastructure ──────────────────────────────────────────────
