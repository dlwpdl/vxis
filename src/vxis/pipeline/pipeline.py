...
class ScanPipeline:
    ...
    async def _phase4_cpr(self, ctx: ScanContext) -> None:
        ...
        try:
            # Phase 4 대응 벡터: 인증, JWT, 세션, OAuth, SAML, 인프라 CVE
            # Phase 4 vectors: Auth, JWT, Session, OAuth, SAML, Infra CVE
            for vid in [
                ...
                "WEB-AUTH-013",  # OAuth State 파라미터 누락 (CSRF) | OAuth State Missing (CSRF)
