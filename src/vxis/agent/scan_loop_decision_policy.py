...
from vxis.agent.scan_loop_decision_policy_memory import ScanLoopDecisionPolicyMemoryMixin
...
class ScanLoopDecisionPolicyMixin(
    ScanLoopDecisionPolicyCampaignMixin,
    ScanLoopDecisionPolicyRetryMixin,
    ScanLoopDecisionPolicyMemoryMixin,
):
