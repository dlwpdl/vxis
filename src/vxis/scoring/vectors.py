...
WEB_VECTORS: tuple[AttackVector, ...] = (
    ...
    AttackVector(
        ...
        name_en="AI/LLM Workflow Code Injection (CVE-2026-33017 Langflow)",
    ...
    AttackVector(
        ...
        name_en="Laravel Livewire RCE (CVE-2025-54068)",
    ...
    AttackVector(
        ...
        name_en="CMS Code Injection (CVE-2025-32432 Craft CMS)",
    ...
    AttackVector(
        ...
        name_en="F5 BIG-IP APM RCE (CVE-2025-53521)",
    ...
    AttackVector(
        ...
        name_en="Magic Link Authentication Bypass",
        name_ko="매직 링크 인증 우회",
        target_types=("web",), phase="Phase 6", max_depth=3,
        owasp_id="A07:2021",
    ),
    AttackVector(
        ...
        name_en="Dependency Supply Chain Attack",
