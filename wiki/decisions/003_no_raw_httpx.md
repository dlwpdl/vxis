...
type: decision
status: active
when_to_read: HTTP 요청 작성 방법 / raw httpx 금지 이유 / Hands·X-Ray·Controller·Finding 모듈 사용 근거
updated: 2026-04-16
sources:
...
- **Enforcement**: 코드 리뷰에서 `import httpx` 가 `agent/skills/` 에 등장하면 blocker. wrapper 확장 또는 예외 주석 필수.
